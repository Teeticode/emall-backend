...
class Product(Base):
    ...
    productid = Column(String, nullable=False, unique=True)
    image = Column(String, nullable=False, server_default="null")
    rating = Column(Integer, nullable=True)
    numReviews = Column(Integer, nullable=True)
...
class Business(Base):
    ...
    productids = Column(String, 
                ForeignKey("products.productid", ondelete="CASCADE"), nullable=False)
